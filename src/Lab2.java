...
public class Lab2 extends javax.swing.JFrame {
    ...
    void JButtonAllSwimmers_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        while (it.hasNext()) {
            swimmer = it.next();
            JTextArea1.append(swimmer.getFname() + " " + swimmer.getLname() + " (" + swimmer.getAge() + ") \n");
        }
    }
    ...
    void JButtonAllBackward_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        while (it.hasNext()) {
            swimmer = it.next();
            JTextArea2.append(swimmer.getFname() + " " + swimmer.getLname() + " (" + swimmer.getAge() + ") \n");
        }
    }
    ...
    void JButtonAllAbove12_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        MyPredicate<Swimmer> ageCheckPreciate = new MyPredicate<Swimmer>() {
            @Override
            public boolean criteria(Swimmer swimmer) {
                return swimmer.getAge() >= 12;
            }
        };

        Iterator it = slist.selectiveIterator(ageCheckPreciate);
        while (it.hasNext()) {
            Swimmer swimmer = (Swimmer) it.next();
            JTextArea3.append(swimmer.getFname() + " " + swimmer.getLname() + " (" + swimmer.getAge() + ") \n");
        }
    }
}
